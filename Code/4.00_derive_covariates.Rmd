...
There are some index encounters with missing insurance information. They are predominantly from FHC encounters. It is unclear if this is because the patient had no insurnace or it was not entered for another reason. 
...
gg_miss_var(pat_cohort_covars %>% 
              select(-c(pat_id, race_groups, employ_source, employ_margin, 
                        employ_clean, parity_final, prior_delivery, race_final, ethnicity_final,
...
gg_miss_upset(pat_cohort_covars %>% 
                select(-c(pat_id, race_groups, employ_source, employ_margin, parity_final, prior_delivery,
...
summary(tableby(complete ~ site_baseline + age_20160801 + bmi_baseline + parity_binary + insur_status +
                  ...
                  ART_use_baseline + HC_status + hcu_baseline, 
